...
class INI:
    ...
    def write_inifile(self, base):
        ...
        print("# Generated by PNCconf at %s" % time.asctime(), file=file)
        print("# Using LinuxCNC version:  %s" % self.d.linuxcnc_version, file=file)
        print("# If you make changes to this file, they will be", file=file)
        print("# overwritten when you run PNCconf again", file=file)
